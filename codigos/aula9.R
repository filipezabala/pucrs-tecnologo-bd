...
### VIDEO 9.2
# Binomial, Poisson, normal, exponencial. As funções set.seed e sample. 
...
# D. Está baseado no teorema de Bayes, que indica a robustez das convergências de medidas assimétricas obtidas a partir da curva de Gauss. 
# E. Pode ser utilizado na estimação da variância da mediana amostral e de parâmetros de regressões. V
